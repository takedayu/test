...
<td>
<button class="buttoncss" onClick="window.open('/20220915kaihatsu/UpdateMSTSEIHIN?SEIHIN_CODE=<%=seihin.getSeihincode() %>','null','menubar=0');" >更新</button>
<a class="buttoncss" href="/20220915kaihatsu/DeleteMSTSEIHIN?SEIHIN_CODE=<%=seihin.getSeihincode() %>" onclick="return confirm('製品コード<%=seihin.getSeihincode()%>を削除してよろしいですか？');">削除</a>
</td>
</tr>
<%} %>
</tbody>
